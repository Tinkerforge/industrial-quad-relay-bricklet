 ...
 *
 * quad_relay.c: Implementation of Industrial Quad Relay Bricklet messages
 *
...
void constructor(void) {
	...
	BC->magic_number1 = MAGIC_NUMBER_INDUSTRIAL_QUAD_RELAY_1;
	BC->magic_number2 = MAGIC_NUMBER_INDUSTRIAL_QUAD_RELAY_2;
...
bool is_group_available(char group) {
	...
	return (BCO(diff)->magic_number1 == MAGIC_NUMBER_INDUSTRIAL_QUAD_RELAY_1) &&
	       (BCO(diff)->magic_number2 == MAGIC_NUMBER_INDUSTRIAL_QUAD_RELAY_2);
}
